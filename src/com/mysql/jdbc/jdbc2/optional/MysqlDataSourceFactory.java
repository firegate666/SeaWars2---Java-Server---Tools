...
public class MysqlDataSourceFactory implements ObjectFactory {
    ...
    public Object getObjectInstance(Object refObj, Name nm, Context ctx,
        ...
        if ((className != null) &&
            ...
            String user = (String) ref.get(NonRegisteringDriver.USER_PROPERTY_KEY).getContent();

            if (user != null) {
                dataSource.setUser(user);
            }

            String password = (String) ref.get(NonRegisteringDriver.PASSWORD_PROPERTY_KEY).getContent();
