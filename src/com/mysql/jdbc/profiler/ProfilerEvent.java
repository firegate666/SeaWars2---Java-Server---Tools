...
public class ProfilerEvent {
	...
	/**
	 * The hostname the event occurred on (as an index
	 * into a dictionary, used by 'remote' profilers
	 * for efficiency)?
	 */
	...
	/**
	 * The catalog the event occurred on (as an index
	 * into a dictionary, used by 'remote' profilers
	 * for efficiency)?
	 */
	...
	/**
	 * Where was the event created (as an index
	 * into a dictionary, used by 'remote' profilers
	 * for efficiency)?
	 */
	...
	/**
	 * Where was the event created (as a string description
	 * of the eventCreationPoint)?
	 */
	...
	/**
	 * Returns the description of when this event was
	 * created.
	 * 
	...
	public String getEventCreationPointAsString() {
		if (this.eventCreationPointDesc == null) {
			this.eventCreationPointDesc = 
				Util.stackTraceToString(this.eventCreationPoint);
		}
	...
	/**
	 * Returns a representation of this event as
	 * a String.
	 * 
	...
	public static ProfilerEvent unpack(byte[] buf) throws Exception {
		...
		return new ProfilerEvent(eventType,
			"",
			"", 
			connectionId, 
			statementId,
			...
			eventCreationTime,
			eventDurationMillis,
			new String(eventCreationAsBytes, "ISO8859_1"),
			null,
	...
	/**
	 * Returns the id of the connection in use
	...
	/**
	 * Returns the point (as a Throwable stacktrace)
	 * where this event was created.
	 * 
	...
	/**
	 * Returns the time (in System.currentTimeMillis() form)
	 * when this event was created
	 * 
	...
	/**
	 * Returns the id of the result set in use
	 * when this event was created.
	 * 
	...
	/**
	 * Returns the id of the statement in use
	 * when this event was created.
	 * 
